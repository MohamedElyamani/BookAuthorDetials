...
public class BookAuthorDetialsDatabaseCheck : IHealthCheck, ITransientDependency
{
    protected readonly IIdentityRoleRepository IdentityRoleRepository;

    public BookAuthorDetialsDatabaseCheck(IIdentityRoleRepository identityRoleRepository)
    {
