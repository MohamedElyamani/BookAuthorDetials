...
{
    [DbContext(typeof(BookAuthorDetialsDbContext))]
    partial class BookAuthorDetialsDbContextModelSnapshot : ModelSnapshot
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BookAuthorDetials.Authors.Author", b =>
                {
                    b.Property<Guid>("Id")
            ...
            modelBuilder.Entity("BookAuthorDetials.Books.Book", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("BookAuthorDetials.Nationalities.Nationality", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BookAuthorDetials.Authors.Author", b =>
                {
                    b.HasOne("BookAuthorDetials.Nationalities.Nationality", null)
                        .WithMany()
            ...
            modelBuilder.Entity("BookAuthorDetials.Books.Book", b =>
                {
                    b.HasOne("BookAuthorDetials.Authors.Author", null)
                        .WithMany()
